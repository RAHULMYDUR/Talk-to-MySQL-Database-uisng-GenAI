...
def main():
    ...
    if st.session_state.conn:
        ...
        selected_database = st.selectbox("Select a database", st.session_state.databases, key="database_selectbox")

        if selected_database and selected_database != st.session_state.selected_database:
            ...
            try:
                ...
                st.write(f"Database Schema: {st.session_state.schema}")
